...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RenovatorJob) DeepCopyInto(out *RenovatorJob) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RenovatorJob.
func (in *RenovatorJob) DeepCopy() *RenovatorJob {
	if in == nil {
		return nil
	}
	out := new(RenovatorJob)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RenovatorJob) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RenovatorJobList) DeepCopyInto(out *RenovatorJobList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RenovatorJob, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RenovatorJobList.
func (in *RenovatorJobList) DeepCopy() *RenovatorJobList {
	if in == nil {
		return nil
	}
	out := new(RenovatorJobList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RenovatorJobList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RenovatorJobSpec) DeepCopyInto(out *RenovatorJobSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RenovatorJobSpec.
func (in *RenovatorJobSpec) DeepCopy() *RenovatorJobSpec {
	if in == nil {
		return nil
	}
	out := new(RenovatorJobSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RenovatorJobStatus) DeepCopyInto(out *RenovatorJobStatus) {
	*out = *in
	if in.StartTime != nil {
	...
	if in.ProcessedRepositories != nil {
		in, out := &in.ProcessedRepositories, &out.ProcessedRepositories
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.FailedRepositories != nil {
		in, out := &in.FailedRepositories, &out.FailedRepositories
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.Conditions != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RenovatorJobStatus.
func (in *RenovatorJobStatus) DeepCopy() *RenovatorJobStatus {
	if in == nil {
		return nil
	}
	out := new(RenovatorJobStatus)
	in.DeepCopyInto(out)
	return out
}
