...
var _ = Describe("Runner Webhook", func() {
	...
	Context("When creating Runner under Validating Webhook", func() {
		var validator RunnerCustomValidator

		BeforeEach(func() {
			validator = RunnerCustomValidator{}
		})

		It("Should accept valid timezone", func() {
			By("setting a valid timezone")

			obj.Spec.Timezone = "Asia/Tokyo"
