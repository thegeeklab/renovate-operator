...
var _ = Describe("RenovateConfig Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			...
			By("creating the custom resource for the Kind RenovateConfig")
			err = k8sClient.Get(ctx, typeNamespacedName, &renovatev1beta1.RenovateConfig{})
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance RenovateConfig")
